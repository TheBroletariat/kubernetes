...
| Node Name | Role | Host OS | Guest OS | IP Address |
| :--- | :--- | :--- | :--- |:--- |
| **magi01** | Control-Plane / Master | Proxmox VE 8.x | Ubuntu 22.04 | xxx.xxx.xxx.xxx |
| **magi02** | Control-Plane / Master | Proxmox VE 8.x | Ubuntu 22.04 | xxx.xxx.xxx.xxx |
| **magi03** | Control-Plane / Master | Proxmox VE 8.x | Ubuntu 22.04 | xxx.xxx.xxx.xxx |
